...
export default function CategoryForm() {
  useTranslationLoader('categoryManagementForm');
  const { language } = useLanguage();
  const { t } = useTranslation('categoryManagementForm');
  ...
  const handleSubmit = async (e) => {
    ...
    const newErrors = validateForm(formData, 'category', language, t);
    setErrors(newErrors);
    ...
    try {
      ...
      formPayload.append('formType', 'category');
      formPayload.append('category_name_en', formData.names.name_en);
      formPayload.append('category_name_vn', formData.names.name_vn);
      formPayload.append(
        'description_en',
      ...
      const response = await uploadCategory(formPayload);
      ...
      <div className='w-full max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden'>
        ...
        <div className='p-6'>
          <form onSubmit={handleSubmit} className='space-y-6'>
            {/* Modified Input for English Name */}
            <Input
              labelText={t('nameEn')}
              typeInput='text'
            ...
            {/* Modified Input for Vietnamese Name */}
            <Input
              labelText={t('nameVn')}
              typeInput='text'
            ...
            {/* Modified Input for Display Order */}
            <Input
